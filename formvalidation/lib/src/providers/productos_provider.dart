...
class ProductosProvider {
  ...
  final String _url = 'https://nwo-fluttervarios.firebaseio.com/';
  ...
  Future<String> subirImagen(File imagen) async {
    ...
    final url = Uri.parse('https://api.cloudinary.com/v1_1/intransort/image/upload?upload_preset=zgqbe5cu');
  ...
  Future<int> borarProducto(String id) async {
